...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-AVMWZOTI.js";
import {
  ActionBar
} from "./chunk-3EHVHEMN.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-5WWCDLJE.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-ASEJUIJB.js";
import {
  P
} from "./chunk-TQS556PK.js";
import {
  require_core_events
} from "./chunk-G2IFUJHB.js";
import {
  stringify
} from "./chunk-HJWDT6AR.js";
import {
  index_modern_default
} from "./chunk-26R7B4GN.js";
import {
  esm_default
} from "./chunk-J6CEENEN.js";
import {
  require_memoizerific
} from "./chunk-OMC5V3RB.js";
import {
  curriedDarken$1,
  curriedLighten$1,
  curriedOpacify$1,
  ...
  rgba
} from "./chunk-GJY2EURF.js";
import {
  require_pickBy
} from "./chunk-K5ADWQM3.js";
import {
  require_uniq
} from "./chunk-A43VE4OP.js";
import {
  require_mapValues
} from "./chunk-IXRTDA6U.js";
import {
  require_cloneDeep
} from "./chunk-J76H454Z.js";
import {
  require_client_logger
} from "./chunk-OYL6NWXF.js";
import {
  require_preview_api
} from "./chunk-75MLHBAP.js";
import {
  require_global
} from "./chunk-2KSNMO5J.js";
import {
  require_react
...
function build_html_default(options) {
  ...
  function updateToc(headingsArray, event) {
    ...
    const clickedHref = ((_a = event == null ? void 0 : event.target) == null ? void 0 : _a.getAttribute) ? (_b = event == null ? void 0 : event.target) == null ? void 0 : _b.getAttribute("href") : null;
    ...
    if (shouldUpdate && !!tocElement && headings.length > 0) {
      ...
      if ((activeTocLink == null ? void 0 : activeTocLink.nextSibling) && activeTocLink.nextSibling.className.indexOf(
  ...
  function getIsHeaderBottomMode(headerId) {
    ...
    const activeHeading = document == null ? void 0 : document.getElementById(headerId);
  ...
  function getScrollTop() {
    ...
    return (el == null ? void 0 : el.scrollTop) || 0;
  }
...
function init(customOptions) {
  ...
  const scrollHandler = (fn, delay) => getScrollHandler(fn, delay, _options.scrollHandlerType);
  _scrollListener = scrollHandler((e) => {
    ...
    const isTop = ((_b = (_a = e == null ? void 0 : e.target) == null ? void 0 : _a.scrollingElement) == null ? void 0 : _b.scrollTop) === 0;
    if (e && (e.eventPhase === 0 || e.currentTarget === null) || isTop) {
      _buildHtml.updateToc(_headingsArray);
      (_c = _options.scrollEndCallback) == null ? void 0 : _c.call(_options, e);
    }
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-K4CPDYWO.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-INGC4MAE.js"));
...
//# sourceMappingURL=chunk-6AGQQLFQ.js.map
