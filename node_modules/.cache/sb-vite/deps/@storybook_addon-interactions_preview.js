...
function format2(...args) {
  if (typeof args[0] != "string") {
    let objects = [];
    for (let i2 = 0; i2 < args.length; i2++) objects.push(inspect(args[i2], { depth: 0, colors: false, compact: 3 }));
    return objects.join(" ");
  }
  ...
  invoke(fn2, object, call, options) {
    ...
    let handleException = (e) => {
      if (e instanceof Error) {
        ...
        if (e !== alreadyCompletedException) throw import_client_logger.logger.warn(e), import_core_events.IGNORED_EXCEPTION;
      }
      throw e;
    };
    try {
